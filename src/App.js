  ...
  render() {
    return (
      <div className="App">
        ...
        <button onClick={this.switchNameHandler.bind(this, "Bobabillion")}>Switch Name</button>
        <Person 
        ...
        <Person 
          ...
          click={this.switchNameHandler.bind(this, "Bobabillion")} >My hobbies: racing</Person>
        <Person 
